...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=14, Polarity=1, Resolution=7, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Slider:IDAC2, CY_INSTANCE_SHORT_NAME=IDAC2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=Slider_IDAC2, )
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=16, Polarity=1, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Slider:IDAC1, CY_INSTANCE_SHORT_NAME=IDAC1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=Slider_IDAC1, )
...
module CapSense_CSD_P4_v2_20_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e64b9a4f-14c3-496e-9ff2-8f139cd9d01e/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e64b9a4f-14c3-496e-9ff2-8f139cd9d01e/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
...
module top ;
    ...
    PrISM_v2_20 RedGreenPrISM (
        ...
        .bitstream(Net_9),
        .tc(Net_10));
    defparam RedGreenPrISM.CompareType0 = 0;
    defparam RedGreenPrISM.CompareType1 = 0;
    defparam RedGreenPrISM.PulseTypeHardcoded = 0;
    defparam RedGreenPrISM.Resolution = 8;

    PrISM_v2_20 BluePrISM (
        .clock(Net_3),
        .enable(Net_12),
        .reset(Net_13),
        .kill(Net_14),
        ...
        .bitstream(Net_17),
        .tc(Net_18));
    defparam BluePrISM.CompareType0 = 0;
    defparam BluePrISM.CompareType1 = 0;
    defparam BluePrISM.PulseTypeHardcoded = 0;
    defparam BluePrISM.Resolution = 8;

    CapSense_CSD_P4_v2_20_3 Slider ();
	...
	cy_psoc3_pins_v1_10
		#(.id("5595c40f-c446-454e-b104-c862b3215f51"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("64267a97-a8ee-4734-bce2-7f806aaf49eb"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
