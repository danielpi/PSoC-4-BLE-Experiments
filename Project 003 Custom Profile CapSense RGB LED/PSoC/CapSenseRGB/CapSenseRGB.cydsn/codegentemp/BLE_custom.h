...
#define CYBLE_CAPSENSECE_SERVICE_SERVICE_INDEX   (0x00u) /* Index of CapSensece Service service in the cyBle_customs array */
#define CYBLE_CAPSENSECE_SERVICE_CAPSENSE_SLIDER_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of CapSense Slider Characteristic characteristic */
#define CYBLE_CAPSENSECE_SERVICE_CAPSENSE_SLIDER_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */
#define CYBLE_CAPSENSECE_SERVICE_CAPSENSE_SLIDER_CHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */
...
#define CYBLE_RGB_LED_SERVICE_RGB_LED_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CYBLE_RGB_LED_SERVICE_RGB_LED_CHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_INDEX   (0x01u) /* Index of Characteristic User Description descriptor */


#define CYBLE_CAPSENSECE_SERVICE_SERVICE_HANDLE   (0x000Cu) /* Handle of CapSensece Service service */
#define CYBLE_CAPSENSECE_SERVICE_CAPSENSE_SLIDER_CHARACTERISTIC_CHAR_HANDLE   (0x000Eu) /* Handle of CapSense Slider Characteristic characteristic */
#define CYBLE_CAPSENSECE_SERVICE_CAPSENSE_SLIDER_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_CAPSENSECE_SERVICE_CAPSENSE_SLIDER_CHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0010u) /* Handle of Characteristic User Description descriptor */
...
#define CYBLE_RGB_LED_SERVICE_RGB_LED_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0014u) /* Handle of Custom Descriptor descriptor */
#define CYBLE_RGB_LED_SERVICE_RGB_LED_CHARACTERISTIC_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0015u) /* Handle of Characteristic User Description descriptor */
