...
#define PrISM_2_PULSE_TYPE_HARDCODED   (0u)
...
#define PrISM_2_CONTROL_REG   (* (reg8 *) PrISM_2_SyncCtl_ControlReg__CONTROL_REG)
#define PrISM_2_CONTROL_PTR   (  (reg8 *) PrISM_2_SyncCtl_ControlReg__CONTROL_REG)
