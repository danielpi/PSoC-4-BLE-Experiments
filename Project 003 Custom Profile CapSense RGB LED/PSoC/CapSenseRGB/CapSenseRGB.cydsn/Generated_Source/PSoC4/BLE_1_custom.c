...
const CYBLE_CUSTOMS_T cyBle_customs[0x02u] = {
    ...
    /* CapSensece Service service */
    {
        0x000Cu, /* Handle of the CapSensece Service service */ 
        {

            /* CapSense Slider Characteristic characteristic */
            {
                0x000Eu, /* Handle of the CapSense Slider Characteristic characteristic */ 
    ...
    /* RGB LED Service service */
    {
        0x0011u, /* Handle of the RGB LED Service service */ 
        {
            ...
            /* RGB LED Characteristic characteristic */
            {
                ...
                /* Array of Descriptors handles */
                {
                    0x0014u, /* Handle of the Custom Descriptor descriptor */ 
