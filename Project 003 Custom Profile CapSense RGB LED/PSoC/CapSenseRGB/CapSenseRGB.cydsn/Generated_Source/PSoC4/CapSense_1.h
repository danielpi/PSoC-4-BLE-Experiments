...
#define CapSense_1_CSH_TANK_PREGARGE_OPTION   (0u)
...
#else
    #define CapSense_1_CFG_REG_TBL_SIZE       (8u)
#endif /* (CY_PSOC4_4000) */
...
#define CapSense_1_PORT_SEL3_PTR          	( (reg32 *) CYREG_HSIOM_PORT_SEL3 )
    ...
    /* Port DR and PC registers */
	#define CapSense_1_PORT7_DR_REG           (*(reg32 *) CYREG_GPIO_PRT7_DR )
	#define CapSense_1_PORT7_DR_PTR           ( (reg32 *) CYREG_GPIO_PRT7_DR )

	/* Port DR and PC registers */
	#define CapSense_1_PORT7_PC_REG           (*(reg32 *) CYREG_GPIO_PRT7_PC )
	#define CapSense_1_PORT7_PC_PTR           ( (reg32 *) CYREG_GPIO_PRT7_PC )
	...
	*******************************************************************************/
		...
		#define CapSense_1_CTANK_PORT_DR_REG          (CapSense_1_PORT4_DR_REG)
	#else
		#define CapSense_1_CMOD_CONNECTION_REG        (CapSense_1_PORT_SEL5_REG)
		#define CapSense_1_CMOD_PORT_PC_REG           (CapSense_1_PORT5_PC_REG)
		#define CapSense_1_CMOD_PORT_DR_REG           (CapSense_1_PORT5_DR_REG)

		#define CapSense_1_CTANK_CONNECTION_REG       (CapSense_1_PORT_SEL5_REG)
		#define CapSense_1_CTANK_PORT_PC_REG          (CapSense_1_PORT5_PC_REG)
		#define CapSense_1_CTANK_PORT_DR_REG          (CapSense_1_PORT5_DR_REG)
	#endif /* (CapSense_1_CSD_FFB__CSD_NUMBER != 1u) */
