...
CYBLE_GAPP_DISC_PARAM_T cyBle_discoveryParam =
{
    ...
    0x01E0u,    /* uint16 advertising_interval_max */
...
{
    { 0x02u, 0x01u, 0x06u, 0x0Du, 0x09u, 0x50u, 0x53u,
    0x6Fu, 0x43u, 0x20u, 0x50u, 0x69u, 0x6Fu, 0x6Eu, 0x65u,
    0x65u, 0x72u, 0x05u, 0x03u, 0xB5u, 0xCAu, 0xBBu, 0xCBu,
...
{
    { 0x07u, 0x16u, 0xBBu, 0xCBu, 0xFFu, 0xFFu, 0xFFu,
...
Return:
 ...
 Global variables:
  The BLE_1_intiVar variable is used to indicate initial
  configuration of this component. The variable is initialized to zero (0u)
  and set to one (1u) the first time BLE_1_Start() is called. This
  allows for component initialization without re-initialization in all
  subsequent calls to the BLE_1_Start() routine.
 ...
 * CYBLE_ERROR_FLASH_WRITE_NOT_PERMITED - Flash Write is not complete
 ...
 Global variables:
  The BLE_1_pendingFlashWrite variable is used to detect status
